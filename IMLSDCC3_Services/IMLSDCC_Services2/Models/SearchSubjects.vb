...
Public Class SearchSubjects
    ...
    Public Sub New(ByVal searchargs1 As String, ByVal wheretosearch As String, ByVal startRecord1 As Integer, ByVal maximumRecords1 As Integer, ByVal scope1 As String, ByVal sort1 As String)
        ...
        uriThisPage = "/Search/Item?subject=" & searchargs1 & "&iStartRecord=" & startRecord1 & "&iMaximumRecords=" & maximumRecords1 & "&scope=" & scope1 & "&sort=" & sort1
        uriNextPage = "/Search/Item?subject=" & searchargs1 & "&iStartRecord=" & startRecord1 + maximumRecords1 & "&iMaximumRecords=" & maximumRecords1 & "&scope=" & scope1 & "&sort=" & sort1
        uriPreviousPage = "/Search/Item?subject=" & searchargs1 & "&iStartRecord=" & startRecord1 - maximumRecords1 & "&iMaximumRecords=" & maximumRecords1 & "&scope=" & scope1 & "&sort=" & sort1

        Dim ret = (From r In db.Records Join r2 In db.RecordsToSubjects On r.recordID Equals r2.recordID Where sublist.Contains(r2.subjectID) Select r.recordID).Take(10000)
