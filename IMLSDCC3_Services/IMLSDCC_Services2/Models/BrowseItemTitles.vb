...
Public Class BrowseItemTitles
    ...
    Public Sub New(ByVal id As String, ByVal startsWith1 As String, ByVal startRecord1 As Integer, ByVal maximumRecords1 As Integer)
        ...
        If (startsWith1 = "0-9") Then
            startsWith1 = "[0-9]"
        End If
        uriThisPage = "/Browse/Item/Titles?startsWith=" & startsWith1 & "&startRecord=" & startRecord & "&maximumRecords=" & maximumRecords
        uriNextPage = "/Browse/Item/Titles?startsWith=" & startsWith1 & "&startRecord=" & startRecord + maximumRecords & "&maximumRecords=" & maximumRecords
        uriPreviousPage = "/Browse/Item/Titles?startsWith=" & startsWith1 & "&startRecord=" & startRecord - maximumRecords & "&maximumRecords=" & maximumRecords

        'Dim rscount = (From r In db.Records Where r.titleNoPunct.StartsWith(startsWith1) Select r.recordID)
        'Dim rs = (From r In db.Records Where r.titleNoPunct.StartsWith(startsWith1) Order By r.titleNoPunct Select r.titleText, r.recordID)
        Dim rs = (From r In db.Records Where SqlMethods.Like(r.titleNoPunct, startsWith1 & "%") Order By r.titleNoPunct Select r.titleText, r.recordID)
