...
Public Class BrowseCollectionTypes
    ...
    Public Sub New(ByVal id As String, ByVal startsWith1 As String, ByVal startRecord1 As Integer, ByVal maximumRecords1 As Integer)
        ...
        uriThisPage = "/Browse/Collection/Types?startsWith=" & startsWith1 & "&startRecord=" & startRecord & "&maximumRecords=" & maximumRecords
        uriNextPage = "/Browse/Collection/Types?startsWith=" & startsWith1 & "&startRecord=" & startRecord + maximumRecords & "&maximumRecords=" & maximumRecords
        uriPreviousPage = "/Browse/Collection/Types?startsWith=" & startsWith1 & "&startRecord=" & startRecord - maximumRecords & "&maximumRecords=" & maximumRecords
        ...
        Dim rscount = (From r In db.CollectionProperties Where r.property = "type_collection" And r.text.StartsWith(startsWith1) Order By r.text Select r.text).Distinct
        Dim rs = (From r In db.CollectionProperties Where r.property = "type_collection" And r.text.StartsWith(startsWith1) Order By r.text Select r.text).Distinct.Skip(startRecord1).Take(maximumRecords1)
        ...
        Else
            ...
            For Each j In temptype
                Dim tempitem As New items("/Search/Collection/type=" & j & "&startRecord=1&maximumRecords=" & maximumRecords, j)
