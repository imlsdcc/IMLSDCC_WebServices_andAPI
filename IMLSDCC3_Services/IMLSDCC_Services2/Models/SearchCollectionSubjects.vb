...
Public Class SearchCollectionSubjects
    ...
    Public Property queries As List(Of String)
        ...
        uriThisPage = "/Search/Collections?subjectCollection=" & searchargs1 & "&cStartRecord=" & startRecord1 & "&cMaximumRecords=" & maximumRecords1 & "&scope=" & scope1 & "&sort=" & sort1
        uriNextPage = "/Search/Collections?subjectCollection=" & searchargs1 & "&cStartRecord=" & startRecord1 + maximumRecords1 & "&cMaximumRecords=" & maximumRecords1 & "&scope=" & scope1 & "&sort=" & sort1
        uriPreviousPage = "/Search/Collections?subjectCollection=" & searchargs1 & "&cStartRecord=" & startRecord1 - maximumRecords1 & "&cMaximumRecords=" & maximumRecords1 & "&scope=" & scope1 & "&sort=" & sort1

        Dim ret = (From c In db.CollectionProperties Where c.text = searchargs1 And c.property = "subject" Select c.collectionID Distinct)
