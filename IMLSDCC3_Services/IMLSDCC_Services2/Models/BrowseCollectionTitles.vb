...
Public Class BrowseCollectionTitles
    ...
    Public Sub New(ByVal id As String, ByVal startsWith1 As String, ByVal startRecord1 As Integer, ByVal maximumRecords1 As Integer)
        ...
        uriThisPage = "/Browse/Collection/Titles?startsWith=" & startsWith1 & "&startRecord=" & startRecord & "&maximumRecords=" & maximumRecords
        uriNextPage = "/Browse/Collection/Titles?startsWith=" & startsWith1 & "&startRecord=" & startRecord + maximumRecords & "&maximumRecords=" & maximumRecords
        uriPreviousPage = "/Browse/Collection/Titles?startsWith=" & startsWith1 & "&startRecord=" & startRecord - maximumRecords & "&maximumRecords=" & maximumRecords
        ...
        Dim rscount = (From r In db.ShortDisplays Where r.title_collection.StartsWith(startsWith1) Select r.collectionID)
        Dim rs = (From r In db.ShortDisplays Where r.title_collection.StartsWith(startsWith1) Order By r.title_collection Select r.title_collection, r.collectionID).Skip(startRecord1).Take(maximumRecords1)
        ...
        Else
            ...
            If Not rs Is Nothing Then
                ...
                For Each j In rs
                    Dim tempitem As New items("/Collection/Detail/" & j.collectionID, Left(j.title_collection, 127))
